...
metadata: 
  ...
  modified: 2026-09-09T12:39:43.116Z
---
...
## Git-stand
Machine laptop (WalterNoot-LAP, WSL). Repo /home/walt/work/sitWordleApi, branch main, HEAD 234650b (5 commits), GEEN remote (Thijmen maakt de GitHub repo zelf, classifier blokkeert gh repo create).

## Status
SDD fase 5 (Test) bezig: gates 0 t/m 3 APPROVED, T001-T008 DONE, T009 wacht op het reviewer-verdict. Deploy bewust NIET gedaan (Thijmen: "je hoeft niet meteen te deployen"). Geen Supabase (Thijmen: "doe zonder supabase maak het simpel"), scores in-memory.
...
- Woord verlaat de server nooit, gameId is HMAC-getekend en op vorm gecheckt.
...
## Volgende stappen
1. Reviewer-verdict verwerken, specs/testReport.md schrijven, gate 5 zetten.
2. Thijmen: `gh repo create molindemol/sitWordleApi --public --source=. --remote=origin --push` in de repo-map.
